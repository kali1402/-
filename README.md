# 나의 포트폴리오
__> 1. Yacht_dice 게임 만들기 (html,js,css) - https://github.com/kali1402/yacht_dice | 도메인 주소 = http://yacht.kro.kr/ (게임플레이 가능)
...
> 8. 검 강화하기 (html,js,css) - 깃허브 주소 X 미완성 추후 정리예정 | 도메인 주소 = http://swordupgrade.kro.kr/ (게임플레이 가능)__
